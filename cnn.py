...
def def_model_cnn_blstm(input_shape):
    ...
    model.add(TimeDistributed(Conv1D(filters=8, kernel_size=128, strides=2, activation='relu'), input_shape=input_shape))
    model.add(TimeDistributed(Conv1D(32, 128, activation='relu')))
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
    model.add(TimeDistributed(Conv1D(64, 128, activation='relu')))
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
    model.add(TimeDistributed(Conv1D(128, 128, activation='relu')))
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
    model.add(TimeDistributed(Conv1D(256, 128, activation='relu')))
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
    model.add(TimeDistributed(Conv1D(256, 128, activation='relu')))
