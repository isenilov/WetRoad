...
def def_model_cnn_blstm(input_shape):
    ...
    model.add(TimeDistributed(Conv1D(filters=128, kernel_size=8, strides=2, activation='relu'), input_shape=input_shape))
    ...
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
    model.add(TimeDistributed(Conv1D(512, 64, activation='relu')))
