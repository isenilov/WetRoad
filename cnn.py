...
def def_model_cnn_blstm(input_shape):
    ...
    model.add(TimeDistributed(Conv1D(64, 64, activation='relu')))
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
    model.add(TimeDistributed(Conv1D(128, 32, activation='relu')))
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
    model.add(TimeDistributed(Conv1D(256, 16, activation='relu')))
    model.add(TimeDistributed(MaxPooling1D(4)))
    model.add(TimeDistributed(Dropout(0.5)))
